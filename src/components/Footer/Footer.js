      ...
      <div className='col-span-1'>
        <div className='my-11 mx-14 2xl:my-1 2xl:mt-6 2xl:mx-20'>
          ...
          <a href='/inicio' smooth="true" >
            <img src={LogoFooter} className='w-44 h-24 xl:w-44 xl:h-24'/>
          </a>
        </div>
      </div>
            ...
            <div className="w-5/6">
              ...
              <div className="d-flex flex-col text-md text-gray-800 mt-5">
                  <div className="flex justify-start items-center my-3">
                    <a
                      href="https://www.facebook.com/aldanaytorrespropiedades"
                      target='_blank'
                    ...
                    <a
                      href="https://www.Instagram.com/aldanaytorrespropiedades"
                      target='_blank'
                      className="text-dark bg-secondary-ligth text-white hover:scale-110 hover:border-secondary duration-300 mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                    >
                      {/* <svg
